// function called whenever user rap on any box
function myfunc()
{
    ...
    //checking if player X won or not and after that
    //disabled all the other friends
    ...
    else if((b4 == 'x' || b4 == 'X')&& (b5 == 'x' || b5 == 'X') && (b6 == 'x' || b == 'X'))
    {
        document.getElementById('print').innerHTML = ('Player X won');
        document.getElementById("b1").disabled = true;
        document.getElementById("b2").disabled = true;
    ...
    else if((b4 == 'o' || b4 == 'O')&& (b5 == 'o' || b5 == 'O') && (b6 == 'o' || b == 'O'))
    {
        document.getElementById('print').innerHTML = ('Player O won');
        document.getElementById("b1").disabled = true;
        document.getElementById("b2").disabled = true;
